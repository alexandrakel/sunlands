            ...
            <div id="rev_slider_1050_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>
                    ...
                    <li data-index="rs-2938" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0"
                        ...
                        data-masterspeed="1500" data-thumb="" data-rotate="0" data-fstransition="fade"
                        data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Intro"
                        data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                        data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="images\slider_bg_1.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                        ...
                        <div class="tp-caption   tp-resizeme sec_off_img hidden-xs" id="slide-2938-layer-2"
                            ...
                            data-y="['top','top','top','bottom']" data-voffset="['70','0','0','0']" data-width="none"
                            ...
                            data-margintop="[0,-150,-100,-100]" data-marginright="[0,0,0,0]"
                            data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]"
                            style="z-index:6;border-width:0px;"><img src="images\index_2_img.png" alt=""
                                data-ww="['653px','653px','330px','230px']" data-hh="['908px','908px','906px','944px']"
                                data-no-retina=""> </div>
                        ...
                        <div class="tp-caption WebProduct-Title   tp-resizeme sec_off_heading_background"
                            ...
                            data-voffset="['-50','-180','130','200']" data-fontsize="['50','50','40','30']"
                            ...
                            Innovative Solar <br>Solutions for <br> Your Home
                        </div>

                        <!-- LAYER NR. 10 -->
                        <div class="tp-caption rev-btn rev-btn waves-effect waves-light waves-ripple slider_btn_boxshdw"
                            id="slide-2938-layer-5" data-x="['left','left','center','center']"
                            data-hoffset="['105','90','0','0']" data-y="['middle','middle','top','top']"
                            data-voffset="['150','20','400','420']" data-width="none" data-height="none"
                            data-whitespace="nowrap" data-type="button"
                            data-actions='[{"event":"click","action":"jumptoslide","slide":"rs-2939","delay":""}]'
                            data-responsive_offset="on" data-responsive="off"
                            data-frames='[{"from":"x:-50px;opacity:0;","speed":1000,"to":"o:1;","delay":1750,"ease":"Power2.easeOut"},{"delay":"wait","speed":1500,"to":"opacity:0;","ease":"Power4.easeIn"},{"frame":"hover","speed":"300","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:#fff;bg:#1d3571;bw:2px 2px 2px 2px;"}]'
                            data-textalign="['center','center','center','center']" data-paddingtop="[0,0,0,0]"
                            data-paddingright="[25,25,25,25]" data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[25,25,25,25]"
                            style="z-index: 1000; white-space: nowrap; font-size: 16px;font-weight: 600; color: #fff;font-family: 'Montserrat', sans-serif;background-color:#1d3571;display:inline-block; border-radius:100px;text-align:center;">
                            <a href="#">Read More </a>
                        </div>
                        ...
                        <div class="tp-caption tp-shape tp-shapewrapper " id="slide-67-layer-1"
                            ...
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                            style="z-index: 1;background-color:rgb(17 17 17 / 90%);"> </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="sw_disc_txt_wrapper">
                            ...
                            <div class="sw_left_heading_wraper">
                                ...
                                <p>Donec quis magna sit amet risus vulputate maximus eget eget arcu. Praesent sed
                                    molestie tortor. </p>
                            </div>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="sw_disc_txt_wrapper">
                        ...
                        <div class="sw_left_heading_wraper">
                            ...
                            <img src="images\heading_line.png" alt="title">
                            <p>Donec quis magna sit amet risus vulputate maximus eget eget arcu. Praesent sed molestie
                                tortor. </p>
                        </div>
                                    ...
                                    <div class="panel-heading desktop">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordionFifteenLeft"
                                                href="#collapseFifteenLeftone" aria-expanded="true">The Cost Benefit
                                                Ratio: </a>
                                        </h4>
                                    </div>
                                    <div id="collapseFifteenLeftone" class="panel-collapse collapse in"
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="panel_cont">
                                                <p>Akshay Handge dolor sit amet, consectetur adipisicing elido eiusmod
                                    ...
                                    <div class="panel-heading horn">
                                        <h4 class="panel-title">
                                            <a class="collapsed" data-toggle="collapse"
                                                ...
                                                aria-expanded="false">Why Solar Energy ?</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="panel-heading bell">
                                        <h4 class="panel-title">
                                            <a class="collapsed" data-toggle="collapse"
                                                ...
                                                aria-expanded="false">Advantage Of Solar</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="panel-heading bell">
                                        <h4 class="panel-title">
                                            <a class="collapsed" data-toggle="collapse"
                                                ...
                                                aria-expanded="false">Solar System Benefits?</a>
                                        </h4>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\websites\blockchain\Ketnology\solar-livewire\sunlar\resources\views/livewire/home.blade.php ENDPATH**/ ?>